...
export default function WaterLevel({ readings, loading }: WaterLevelGraphProps) {
    ...
    const descriptionMap = {
        hourly: 'Hourly average water level',
        daily: 'Daily average water level',
        weekly: 'Weekly average water level',
        monthly: 'Monthly average water level',
        yearly: 'Yearly average water level',
    };
        ...
        <Card className="lg:col-span-2">
            <CardHeader className="overflow-visible">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <CardTitle>Water Level Trend</CardTitle>
                        <CardDescription>{descriptionMap[interval as keyof typeof descriptionMap] || 'Water level changes over time'}</CardDescription>
                    </div>
                ...
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={data} margin={{ top: 8, right: 12, left: 0, bottom: 8 }}>
                            ...
                            />
                            <RechartsTooltip
                                formatter={(value: unknown) => `${value} cm`}
