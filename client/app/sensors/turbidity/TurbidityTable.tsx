...
export default function TurbidityTable({ sensor, readings, loading }: TurbidityTableProps) {
    ...
    if (loading) {
        return (
            <Card>
                <CardHeader>
                    <CardTitle>Turbidity Readings</CardTitle>
                    <CardDescription>
                            ...
                            {currentReadings.map((reading) => (
                                <TableRow key={`${reading.sensor_id}-${reading.recorded_at}`}>
                                    ...
                                    <TableCell className="text-center">
                                        {(() => {
                                            const matched = findThreshold(reading.value, sensor?.thresholds, 'turbidity');
                                            const status = matched?.name ?? getReadingStatus(reading.value, sensor?.thresholds, 'turbidity');
