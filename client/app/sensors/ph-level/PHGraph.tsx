...
export default function PHGraph({ readings, loading }: PHGraphProps) {
        ...
        return (
            <Card className="lg:col-span-2">
                <CardHeader>
                    ...
                    <CardDescription>pH changes over time</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="h-64">
    ...
    const descriptionMap = {
        hourly: 'Hourly average pH level',
        daily: 'Daily average pH level',
        weekly: 'Weekly average pH level',
        monthly: 'Monthly average pH level',
        yearly: 'Yearly average pH level',
    };
        ...
        <Card className="lg:col-span-2">
            <CardHeader className="overflow-visible">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <CardTitle>pH Trend</CardTitle>
                        <CardDescription>{descriptionMap[interval as keyof typeof descriptionMap] || 'pH changes over time'}</CardDescription>
                    </div>
                ...
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={data} margin={{ top: 8, right: 12, left: 0, bottom: 8 }}>
                            ...
                            />
                            <RechartsTooltip
                                formatter={(value: unknown) => `${value} pH`}
