    ...
    useEffect(() => {
        const fetchSensor = async () => {
            try {
                ...
                if (data.thresholds && Array.isArray(data.thresholds.ph)) {
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    const parsed = data.thresholds.ph.map((t: any) => ({
                        name: t.name,
                        min: t.min,
                        max: t.max,
            ...
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        id="description"
                                        type="text"
                                        placeholder="e.g., Main ph sensor for koi pond"
                                        value={description}
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Define pH ranges for different conditions</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            {thresholds.length === 0 ? (
                ...
                <div className="flex gap-3 justify-end">
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        onClick={() => router.push('/sensors/ph-level')}
                    >
                        Cancel
                    </Button>
                </div>
