...
export default function PHTable({ sensor, readings, loading }: TemperatureTableProps) {
    ...
    if (loading) {
        return (
            <Card>
                <CardHeader>
                    <CardTitle>pH Readings</CardTitle>
                    <CardDescription>
                            ...
                            {currentReadings.map((reading) => (
                                <TableRow key={`${reading.sensor_id}-${reading.recorded_at}`}>
                                    ...
                                    <TableCell className="text-center">
                                        {(() => {
                                            const matched = findThreshold(reading.value, sensor?.thresholds, 'ph');
                                            const status = matched?.name ?? getReadingStatus(reading.value, sensor?.thresholds, 'ph');
